...
const fetchRooms = async () => {
    try {
        const response = await fetch('http://172.20.10.5:8080/rooms_id_and_name');
...
const fetchUsers = async () => {
    try {
        const response = await fetch('http://172.20.10.5:8080/users');
...
const saveModifiedBooking = async () => {
    try {
        ...
        console.log(3)
        const response = await fetch(`http://172.20.10.5:8080/modifyBooking`, {
            method: 'PUT',
...
const cancelBooking = async (booking_id) => {
    try {
        const response = await fetch(`http://172.20.10.5:8080/bookings/${booking_id}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
...
const fetchBookings = async () => {
    try {
        const response = await fetch('http://172.20.10.5:8080/bookings');
